...
public class MyHeapTest {
	...
	private Integer arrayOfUnderTestHalf[] = {9, 1, 9, 8, null, null, null, null};
	...
	public void testMyHeap1() {
		MyHeap<Integer> testMyHeap1 = new MyHeap<>(-1);
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testMyHeap2() {
		MyHeap<Integer> testMyHeap2 = new MyHeap<>(0);
	}
	...
	public void testMyHeap4() {
		...
		assertArrayEquals(arrayOfUnderTest, testMyHeap4.toArray());
	}
	...
	public void testContains1() {
		assertEquals(true, underTestEmpty.contains(null));
	}
	...
	public void testToArrayTArray4() {
		...
		assertArrayEquals(arrayOfUnderTestOne, underTestOne.toArray(array)); 
	}
	...
	public void testRemoveObject11() {
		...
		assertArrayEquals(arrayOfUnderTest, myHeap.toArray());
	}

	@Test
	public void testContainsAll1() {
		assertEquals(true, underTestEmpty.containsAll(Arrays.asList(arrayOfUnderTestEmpty)));
	}
	
	@Test
	public void testContainsAll2() {
		assertEquals(false, underTestEmpty.containsAll(Arrays.asList(arrayOfUnderTestOne)));
	}
	
	@Test
	public void testContainsAll3() {
		assertEquals(false, underTestEmpty.containsAll(Arrays.asList(arrayOfUnderTest)));
	}
	
	@Test
	public void testContainsAll4() {
		assertEquals(true, underTestOne.containsAll(Arrays.asList(arrayOfUnderTestEmpty)));
	}
	
	@Test
	public void testContainsAll5() {
		assertEquals(true, underTestOne.containsAll(Arrays.asList(arrayOfUnderTestOne)));
	}
	
	@Test
	public void testContainsAll6() {
		assertEquals(false, underTestOne.containsAll(Arrays.asList(arrayOfUnderTest)));
	}
	
	@Test
	public void testContainsAll7() {
		assertEquals(true, underTest.containsAll(Arrays.asList(arrayOfUnderTestEmpty)));
	}
	
	@Test
	public void testContainsAll8() {
		assertEquals(true, underTest.containsAll(Arrays.asList(arrayOfUnderTestOne)));
	}
	
	@Test
	public void testContainsAll9() {
		assertEquals(true, underTest.containsAll(Arrays.asList(arrayOfUnderTest)));
	}
	...
	public void testAddAll1() {
		assertEquals(false, underTestEmpty.addAll(Arrays.asList(arrayOfUnderTestEmpty)));
		assertArrayEquals(arrayOfUnderTestEmpty, underTestEmpty.toArray());
	}
	
	@Test
	public void testAddAll2() {
		assertEquals(true, underTestEmpty.addAll(Arrays.asList(arrayOfUnderTestOne)));
		assertArrayEquals(arrayOfUnderTestOne, underTestEmpty.toArray());
	}
	
	@Test
	public void testAddAll3() {
		assertEquals(true, underTestEmpty.addAll(Arrays.asList(arrayOfUnderTest)));
		assertArrayEquals(arrayOfUnderTest, underTestEmpty.toArray());
	}
	
	@Test
	public void testAddAll4() {
		assertEquals(false, underTestOne.addAll(Arrays.asList(arrayOfUnderTestEmpty)));
		assertArrayEquals(arrayOfUnderTestOne, underTestOne.toArray());
	}
	...
	public void testAddAll7() {
		assertEquals(false, underTest.addAll(Arrays.asList(arrayOfUnderTestEmpty)));
		assertArrayEquals(arrayOfUnderTest, underTest.toArray());
	}
	...
	public void testRemoveAll1() {
		assertEquals(false, underTestEmpty.removeAll(Arrays.asList(arrayOfUnderTestEmpty)));
		assertArrayEquals(arrayOfUnderTestEmpty, underTestEmpty.toArray());
	}
	
	@Test
	public void testRemoveAll2() {
		assertEquals(false, underTestEmpty.removeAll(Arrays.asList(arrayOfUnderTestOne)));
		assertArrayEquals(arrayOfUnderTestEmpty, underTestEmpty.toArray());
	}
	
	@Test
	public void testRemoveAll3() {
		assertEquals(false, underTestEmpty.removeAll(Arrays.asList(arrayOfUnderTest)));
		assertArrayEquals(arrayOfUnderTestEmpty, underTestEmpty.toArray());
	}
	
	@Test
	public void testRemoveAll4() {
		assertEquals(false, underTestOne.removeAll(Arrays.asList(arrayOfUnderTestEmpty)));
		assertArrayEquals(arrayOfUnderTestOne, underTestOne.toArray());
	}
	
	@Test
	public void testRemoveAll5() {
		assertEquals(true, underTestOne.removeAll(Arrays.asList(arrayOfUnderTestOne)));
		assertArrayEquals(arrayOfUnderTestEmpty, underTestOne.toArray());
	}
	
	@Test
	public void testRemoveAll6() {
		assertEquals(false, underTestOne.removeAll(Arrays.asList(arrayOfUnderTest)));
		assertArrayEquals(arrayOfUnderTestOne, underTestOne.toArray());
	}
	
	@Test
	public void testRemoveAll7() {
		assertEquals(false, underTest.removeAll(Arrays.asList(arrayOfUnderTestEmpty)));
		assertArrayEquals(arrayOfUnderTest, underTest.toArray());
	}
	...
	public void testRemoveAll11() {
		assertEquals(true, underTest.removeAll(Arrays.asList(arrayOfUnderTest)));
	...
	public void testRemoveAll12() {
		...
		assertEquals(false, underTest.removeAll(Arrays.asList(array)));
		assertArrayEquals(arrayOfUnderTest, underTest.toArray());
	}

	@Test
	public void testRetainAll1() {		
		assertEquals(false, underTestEmpty.retainAll(Arrays.asList(arrayOfUnderTestEmpty)));
		assertArrayEquals(arrayOfUnderTestEmpty, underTestEmpty.toArray());
	}

	@Test
	public void testRetainAll2() {
		assertEquals(false, underTestEmpty.retainAll(Arrays.asList(arrayOfUnderTestOne)));
		assertArrayEquals(arrayOfUnderTestEmpty, underTestEmpty.toArray());
	}

	@Test
	public void testRetainAll3() {
		assertEquals(false, underTestEmpty.retainAll(Arrays.asList(arrayOfUnderTest)));
		assertArrayEquals(arrayOfUnderTestEmpty, underTestEmpty.toArray());
	}
	
	@Test
	public void testRetainAll4() {
		assertEquals(false, underTestOne.retainAll(Arrays.asList(arrayOfUnderTestEmpty)));
		assertArrayEquals(arrayOfUnderTestOne, underTestOne.toArray());
	}
	
	@Test
	public void testRetainAll5() {
		assertEquals(false, underTestOne.retainAll(Arrays.asList(arrayOfUnderTestOne)));
		assertArrayEquals(arrayOfUnderTestOne, underTestOne.toArray());
	}
	
	@Test
	public void testRetainAll6() {
		assertEquals(false, underTestOne.retainAll(Arrays.asList(arrayOfUnderTest)));
		assertArrayEquals(arrayOfUnderTestOne, underTestOne.toArray());
	}
	...
	public void testRetainAll8() {
		assertEquals(false, underTest.retainAll(Arrays.asList(arrayOfUnderTestEmpty)));
		assertArrayEquals(arrayOfUnderTest, underTest.toArray());
	}
	
	@Test
	public void testRetainAll9() {
		assertEquals(true, underTest.retainAll(Arrays.asList(arrayOfUnderTestOne)));
		assertArrayEquals(arrayOfUnderTestOne, underTest.toArray());
	}
	
	@Test
	public void testRetainAll10() {
		assertEquals(false, underTest.retainAll(Arrays.asList(arrayOfUnderTest)));
		assertArrayEquals(arrayOfUnderTest, underTest.toArray());
	}
