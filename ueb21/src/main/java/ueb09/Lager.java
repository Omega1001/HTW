...
public class Lager implements Iterable<Artikel> {
	...
	public void applyToArticles(Consumer<Artikel> operation) {
		//TODO Warum brauche ich immer this. wenn ich den iterator verwende? (hab das gefühl ich müsste das wissen werd aber nicht schaldu daraus warum es mit Lagerfeld nicht geht.)
