...
{	
	...
	{			
		...
		{
			throw new IllegalArgumentException ( "Die Teilersummenzahl muss eine nat�rliche Zahl sein!" );
		}
		else 
		{	
	...
	public static String berechnePrufZifferISBN_10 ( long iSBN_10_9 )
	{
		...
		{	
			...
			losung = ( "ISBN-10 Pr�fziffer lautet: " + prufZiffer); //+ " ;Vollst�ndige ISBN-10 lautet: " + iSBN_10_9 + "-" + prufZiffer ); !Funktioniert nicht da f�hrende Nullen geschluckt werden / 9 if Anweisungen sind "unsch�n" / keine Ahnung wie man L�nge eines longs checkt!
		}
		return losung;
	}
	/**
