...
public class Math {
    ...
    public static int berechneTeilerSumme(int teilerSummenZahl) {
        ...
        // Pr√ºft ob die uebergebene Zahl kleiner als 0 ist.
     ...
     * <p>
     * 
     * Eine ISBN 10 besteht aus 9 zahlen von [0-9] und der Pr√ºfziffer
     ...
     * f√ºhrende 0en gestattet sind!<br>
     * 
     * @param isbn
    ...
    public static String berechnePrufZifferISBN_10(long isbn) {
        ...
        // wobei
        // die isbn f√ºhrende 0en haben darf, die bei der convertierung zu
        // long verloren
        // gingen.
    ...
    long ZahlenTripel [ ] [ ] = new long [ 100 ] [ 3 ];
    int zeilenNummer = 0;
    
    if ( schrankeMAX < 1 )
    {
        throw new IllegalArgumentException 
            ( "Die Schranke muss eine nat¸rliche Zahl sein!" );
    }
    ...
    private static double berechneB ( long a, long c)
    {
        ...
        b = java.lang.Math.cbrt ( c * c - a * a * a ); //warum gibt das dahinter immer 1,0 aus?java.lang.Math.pow ( ( c * c - a * a * a ), ( 1 / 3 ) ); FUCK WIEDER ES VERDAMMTE D VERGESSE LASSE DAS JETZT ALS MAHNMAL F‹R MICH STEHE!!! java.lang.Math.pow ( ( c * c - a * a * a ), ( 1d / 3d ) ); funktioniert einwandfrei
    ...
    public static double berechneSumme ( long n, double x )
    {
    	...
    	if ( n < 1)
    	{
    		throw new IllegalArgumentException ( "n muss eine nat¸rliche Zahl sein!" );
    	}
    	for ( long i = 1; i <= n; i++)
    	{
    		Summe += java.lang.Math.pow ( x - 1, i ) / ( i * java.lang.Math.pow ( x, i ) );
    	}
