...
public class LOCCounterDialog  {
	 ...
	 * This constructor generates a new, interactive object of the type {@link LOCCounterDialog} in order to communicate with an object of the type {@link LOCCounter}.
	 * <p>
	 ...
	 * This constructor generates a new, interactive object of the type {@link LOCCounterDialog} in order to communicate with an object of the type {@link LOCCounter}.
	 * <p>
	 * This constructor also allows an already existing object of the type {@link LOCCounter} to be imported.<br>
	 * The imported object can be null in case no object is imported.
	 * <p>
	 * There also has to be a {@link InputStream} imported, which is used to read input.<br>
	 * If the {@link InputStream} is null a {@link IllegalArgumentException} will be thrown.
	 * <p>
	 * A {@link PrintStream} has to be imported to pass output.<br>
	 * If the {@link PrintStream} is null a {@link IllegalArgumentException} will be thrown.
	 * <p>
	 * A {@link PrintStream} can be imported to pass errors.<br>
	 * If the {@link PrintStream} is null errors will be passed to {@link #OUT}.
	 * <p>
	 * @param locCounter
	 ...
	 * 		Output
	 */
	public LOCCounterDialog(LOCCounter locCounter, InputStream in, PrintStream out, PrintStream err) {
		if (in == null) {
	 ...
	 * This method blocks the initiating thread until the interaction is done.<br>
	 ...
	 * <p>
	 * The return value of this method decides whether the Dialog will be closed.<br>
	...
	private boolean processNext(){
		...
		OUT.println();
		char selected = 'j';
		OUT.print("Moechten sie die Anzahl an Codezeilen einer .java-Datei auswerten? ");
		selected = getJN();
		if('n' == selected) {
			return true;
		}
		while ('n' != selected) {
			...
			OUT.println("Eine weitere .java-Datei übergeben?");
			selected = getJN();
		}
	 ...
	 * This method reads until it come across a non empty text followed by a line feed/carriage return.
	 * <p>
	 * @return 
	 * 		A non empty line of text read from the Input.
	 */
	 ...
	 * This method reads until it comes across an input solely consisting of either 'j' or 'n'.
	 * <p>
	 * @return
	 * 		Either the char 'j' or 'n'.
	 */
	private char getJN() {
		char cha = 0;
		String line = "";
